...
<div id="text_para" class="mt120" style="margin-left: 60px;">
    ...
    <span class="mb20 mt20" id="get_all_site_data">
        <a href="<?=site_url('admin/admin_set_data') ?>" target="_blank">Get All site data</a> |
    </span>
    <span id="get_all_site_data" style="margin-left: 5px;">
        <b><?=$count_approved_sites;  ?></b> sites approved |
    </span>
    <span id="get_all_site_data" style="margin-left: 5px;">
        <em>"Promo" period start date: <?=$promo_period_start;  ?> </em>|
    </span>
        ...
        <div id="one_site">
            ...
            foreach ($not_approved as $one) {
                ...
                echo '<div id="cell">' .
                        ...
                        '<a href="http://' . $one['link'] . '" target="_blank">' . $one['link'] . '</a>,' . $one['site'].
                        'User ID:  '.
